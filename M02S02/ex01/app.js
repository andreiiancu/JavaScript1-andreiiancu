...
// // Creaza un div cu clasa navigation si adauga-l dupa divul anterior,
// folosind metoda .after() https://api.jquery.com/after/
 $div = $('<div>', {
    class: 'navigation',
});
$('<div class = "navigation"></div>').after($divcontainer);

// // Creeaza un element de tip ancora cu textul Primul Link si clasa nav-link
// si adauga-l la divul cu clasa navigation.
 $a = $('<a>', {
    class: 'nav-link',
    text: 'Primul link',
}).appendTo('.navigation');

// // Creeaza un element h2 cu textul “Navigatie” si folosind metoda .before()
// adauga-l la divul cu clasa navigation. Selectorul lui before va trebui sa fie
// selectorul ancorei pentru a functiona corect. Exemplu: .navigation .nav-link
// // https://api.jquery.com/before/
$h2 = $h2('<h2>', {
  text: 'navigatie',
})

$( '.navigation ').before( $( 'h2' ) );

// // Creeaza un element de tip sup cu textul 1 si folosind metoda .prepend()
// adauga-l in ancora .nav-link
$sup = $sup('<sup>', {
  text: '1',
})
