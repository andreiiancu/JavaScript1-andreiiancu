...
console.warn(`
  Folosind functia calculateRectangleArea() afiseaza suprafata
  unui dreptunghi de 12 pe 9
`);
...
`);
let rectangleSurface1 = calculateRectangleArea(15, 31);
let rectangleSurface2 = calculateRectangleArea(8, 9);
let rectangleSurface3 = calculateRectangleArea(10, 5);

console.log(rectangleSurface1 + rectangleSurface2 + rectangleSurface3);
