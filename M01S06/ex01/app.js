...
// Adauga o proprietate booleana numita areLightsOn si asigneaza-i
// valoarea false.
...
let car = {
  ...
  wheels: 4,
  speed: 50,
  isTrunkOpen: false, //ex01
  areLightsOn: false, //propriet booleana
  accelerate: function () {
    this.speed++;
  },
  decelerate: function () {
...
//arrow function
// daca avem un obiect literal, putem folosi cu function
